      ...
      <div className="max-w-full space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-slate-400">Advanced volatility analysis and tail-risk quantification for HOSE equities</p>
          </div>
          <div className="flex items-center gap-3 bg-gray-50/50 dark:bg-slate-900/50 p-2 rounded-2xl border border-gray-100 dark:border-slate-800">
            <div className="flex gap-2">
              ...
              <Input
                ...
                className="w-24 bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700 rounded-xl font-bold uppercase h-9 text-xs"
                maxLength={10}
              />
              <Select
                value={benchmark}
                onChange={(e) => setBenchmark(e.target.value)}
                className="w-32 bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700 rounded-xl h-9 text-xs font-bold"
                options={[
            ...
            <Button onClick={handleSearch} disabled={loading} size="sm" className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl h-9 font-bold px-4">
              ...
              <Card className="bg-red-50/50 dark:bg-red-900/10 border-red-100 dark:border-red-900/30">
                <CardContent className="p-3">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-[10px] font-bold text-gray-500 dark:text-slate-500 uppercase tracking-wider">VaR (95%)</span>
                  </div>
              ...
              <Card className="bg-blue-50/50 dark:bg-blue-900/10 border-blue-100 dark:border-blue-900/30">
                <CardContent className="p-3">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-[10px] font-bold text-gray-500 dark:text-slate-500 uppercase tracking-wider">Beta vs {result.benchmark}</span>
                  </div>
                  <p className="text-lg font-bold text-blue-600 dark:text-blue-400">{isFinite(result.metrics.beta) ? result.metrics.beta.toFixed(2) : "N/A"}</p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-3">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-[10px] font-bold text-gray-500 dark:text-slate-500 uppercase tracking-wider">Max Drawdown</span>
                  </div>
                  <p className="text-lg font-bold text-gray-900 dark:text-slate-100">{formatPercent(result.metrics.maxDrawdown)}</p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-3">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-[10px] font-bold text-gray-500 dark:text-slate-500 uppercase tracking-wider">Sortino Ratio</span>
                  </div>
                  <p className="text-lg font-bold text-gray-900 dark:text-slate-100">{isFinite(result.metrics.sortinoRatio) ? result.metrics.sortinoRatio.toFixed(2) : "N/A"}</p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-3">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-[10px] font-bold text-gray-500 dark:text-slate-500 uppercase tracking-wider">Info Ratio</span>
                  </div>
                  <p className="text-lg font-bold text-gray-900 dark:text-slate-100">{isFinite(result.metrics.informationRatio) ? result.metrics.informationRatio.toFixed(2) : "N/A"}</p>
                </CardContent>
              </Card>
            </div>
            ...
            <Tabs defaultValue="series" className="w-full">
              <div className="flex items-center justify-between mb-4 bg-gray-50/50 dark:bg-slate-900/50 p-1.5 rounded-xl border border-gray-100 dark:border-slate-800">
                <TabsList className="bg-transparent border-none">
                  <TabsTrigger value="series" className="data-[state=active]:bg-white dark:data-[state=active]:bg-slate-800 data-[state=active]:shadow-sm text-xs font-bold px-6">
                    Risk Time-Series
                  </TabsTrigger>
                  <TabsTrigger value="tail" className="data-[state=active]:bg-white dark:data-[state=active]:bg-slate-800 data-[state=active]:shadow-sm text-xs font-bold px-6">
                    Tail Risk Analysis
                  </TabsTrigger>
                  <TabsTrigger value="benchmarks" className="data-[state=active]:bg-white dark:data-[state=active]:bg-slate-800 data-[state=active]:shadow-sm text-xs font-bold px-6">
                    Benchmark Comparison
                  </TabsTrigger>
                </TabsList>
                <div className="flex items-center gap-2 pr-2">
                  <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">{result.symbol} vs {result.benchmark}</span>
                </div>
              </div>
              ...
              <TabsContent value="tail" className="mt-0">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <Card className="md:col-span-2">
                    ...
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className="p-4 bg-red-100/50 dark:bg-red-900/20 rounded-2xl border border-red-200 dark:border-red-900/40">
                      ...
                      <div className="pt-4 border-t border-gray-100 dark:border-slate-800">
                        <div className="flex items-center gap-2 mb-3">
                          ...
                          <span className="text-xs font-bold text-gray-700 dark:text-slate-300 uppercase">Conditional VaR (Expected Shortfall)</span>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <p className="text-[10px] font-bold text-gray-400 uppercase">CVaR (95%)</p>
                            <p className="text-sm font-bold font-mono">{formatPercent(result.metrics.cvar95)}</p>
                          </div>
                          <div>
                            <p className="text-[10px] font-bold text-gray-400 uppercase">Tail Loss Ratio</p>
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-xs font-bold text-gray-500 uppercase">Risk Assessment</CardTitle>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center font-mono">
                          <span className="text-xs text-gray-500">Current DD</span>
                          <span className="text-xs font-bold text-red-500">{formatPercent(result.analysis?.currentDrawdown ?? 0)}</span>
                        </div>
                        <div className="flex justify-between items-center font-mono">
                          <span className="text-xs text-gray-500">DD Duration</span>
                          <span className="text-xs font-bold">{result.analysis?.currentDrawdownDuration ?? 0} days</span>
                        </div>
                      </div>
                      
                      <div className="pt-4 border-t border-gray-100 dark:border-slate-800">
                        <p className="text-[10px] font-bold text-blue-600 dark:text-blue-400 uppercase mb-2">Quant Insight</p>
              ...
              <TabsContent value="benchmarks" className="mt-0">
                <Card className="rounded-2xl border-gray-100 dark:border-slate-800">
                  <CardHeader>
                    <CardTitle className="text-xs font-bold text-gray-500 uppercase tracking-wider">Benchmarking & Relative Risk</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                      <div className="space-y-1">
                        <p className="text-[10px] font-bold text-gray-400 uppercase">Tracking Error</p>
                        <p className="text-xl font-bold font-mono">{formatPercent(result.metrics.trackingError)}</p>
                        <p className="text-[9px] text-gray-400 italic">Active risk vs {result.benchmark}</p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-[10px] font-bold text-gray-400 uppercase">Information Ratio</p>
                        <p className="text-xl font-bold font-mono">{result.metrics.informationRatio?.toFixed(2)}</p>
                        <p className="text-[9px] text-gray-400 italic">Risk-adjusted active return</p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-[10px] font-bold text-gray-400 uppercase">Downside Dev.</p>
                        <p className="text-xl font-bold font-mono text-amber-600">{formatPercent(result.metrics.downsideDeviation)}</p>
                        <p className="text-[9px] text-gray-400 italic">Risk of negative returns only</p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-[10px] font-bold text-gray-400 uppercase">Benchmark</p>
        ...
        {!result && !loading && !error && (
          <Card className="rounded-3xl border-dashed border-2 border-gray-200 dark:border-slate-800 bg-gray-50/30 dark:bg-slate-900/30">
            <CardContent className="flex flex-col items-center justify-center py-20">
              ...
              <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Risk Quantification Engine</h3>
              <p className="text-sm text-gray-500 dark:text-slate-400 mb-8 max-w-sm text-center">Enter a symbol above to calculate institutional-grade risk metrics and visualize volatility profiles.</p>
              <Button onClick={handleSearch} className="rounded-xl px-8 bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-500/20">
                Begin Analysis
              </Button>
            </CardContent>
          </Card>
...
export default function RiskPage() {
  return (
    <Suspense fallback={<div className="p-6 text-sm text-gray-500 dark:text-slate-400">Loading risk workspace...</div>}>
      <RiskPageContent />
    </Suspense>
  );
}
